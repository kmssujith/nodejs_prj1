...
exports.ajaxpag = function(req, res){
   ...
   if(userId == null){
    ...
    db.query(sql, (err, result) => {
        ...
        if(page > numberOfPages){
            res.redirect('/home/ajaxsearch/?page='+encodeURIComponent(numberOfPages));
        }else if(page < 1){
            res.redirect('/home/ajaxsearch/?page='+encodeURIComponent('1'));
        }
        ...
        db.query(sql, (err, result)=>{
            ...
            res.render('ajaxsearch.ejs', {data: result.recordset, endingLink, page, iterator, numberOfPages});
           
        });
    }
    else
    {
        res.render('ajaxsearch.ejs', {error:"No Data Found"});
    }
